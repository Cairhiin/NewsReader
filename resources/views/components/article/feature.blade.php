            ...
            <div class="@if($loop->index < 2) md:col-span-2 @endif  @if($loop->index == 0) md:row-span-2 @endif relative">
                <a href="articles/{{$article->id}}">
                    <figure class="h-full @if($loop->index == 1) md:col-span-2 @endif">
                        <img class="@if($loop->index > 1) box-border border-t-4 @endif object-none h-72  md:h-48 
                        ...
                        <figcaption>
                            ...
                            <h2 class="absolute bottom-0 py-4 px-4 text-white text-xl font-bold drop-shadow leading-6
