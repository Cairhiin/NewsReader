<nav class="sticky top-0 z-10">
    <div class="flex flex-col md:flex-row md:justify-between md:items-center bg-stone-900 dark:bg-zinc-900 text-gray-100 md:p-3">
        ...
        <div>
            ...
            @else
                <div class="divide-y divide-slate-900">
                    <a class="md:mx-2 md:inline p-3" href="/register"><i class="fa-solid fa-user-plus pr-2"></i> Register</a>
                    <a class="md:inline p-3" href="/login"><i class="fa-solid fa-arrow-right-to-bracket pr-2"></i> Login</a>
                </div>
            @endauth
            </div>
        </div>
    ...
    @if ($categories)
    <div class="flex justify-start bg-stone-200 text-stone-900 dark:bg-black dark:text-zinc-200 p-3">
