<nav class="sticky top-0 z-10">
    <div class="flex flex-col md:flex-row md:justify-between md:items-center bg-stone-900 text-gray-100 md:p-3">
        ...
        @else
        <div id="menu" 
            class="absolute w-full -left-full aria-checked:left-0 md:relative md:left-0 transition-all easeout duration-500
                md:block md:inline md:ml-2 md:mr-4 bg-slate-800 divide-y divide-slate-900 md:bg-stone-900"
        >
